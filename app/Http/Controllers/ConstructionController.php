...
class ConstructionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        @if($construcaoCriada)
            ...
            return redirect('/constructions.store')->with('message', 'Obra criada com sucesso');

        @endif

        return redirect('/constructions.store')->with('message', 'EEEEEEEEEEEEEEERRRRRRROOOOOOOOORRRRRR'); 
    ...
    public function update(Request $request, string $id)
    {
        ...
        @if($atualizarConstrucao)
            ...
            return redirect('/constructions.store')->with('message', 'Obra atualizada com sucesso');
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('/constructions.store')->with('message', 'Construção excluída com sucesso');
    }
}